...
|-----------|----------|----------|
| Architecture, scope, priorities | Keaton 🏗️ | API design, data model, what ships in v1, trade-offs |
| React components, pages, UI, CSS | McManus ⚛️ | Build HomePage, style cards, implement search UI, responsive layout |
| Azure Functions, Blob Storage, API | Fenster 🔧 | Upload endpoint, SAS URL generation, manifest proxy, GitHub Action |
| Tests, quality, edge cases | Hockney 🧪 | Write unit tests, validate acceptance scenarios, coverage checks |
